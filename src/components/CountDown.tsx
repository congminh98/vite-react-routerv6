...
const spanStyles = {
  ...
  'p2': 'py-1 text-base font-playBall',
}
...
function CountDown({ }: Props) {
  ...
  return (
    <>
      <section className="relative h-screen overflow-hidden bg-cover mb-14 md:mb-0 place-items-center section-countdown md:bg-anhcuoi md:bg-center">
        <div className="flex justify-center w-full before:absolute before:w-full before:h-full before:transition before:left-0 before:top-0 before:bg-before before:z-10 after:absolute after:hidden after:bottom-0 after:left-0 after:h-0 after:border-t-[100px] after:border-r-[50vw] after:border-b-0 after:border-l-[50vw] after:border-after after:z-30 after:opacity-80 md:before:bg-beforemd md:after:border-t-[50px]">
        ...
        <div className="relative z-20 grid items-center content-center h-full countdown-content justify-items-center">
          ...
          <p className="my-8 text-3xl font-semibold text-amber-200 md:text-xl md:my-5 font-vibes" data-aos="fade-up" data-aos-duration="500" data-aos-delay="1200" data-aos-anchor-placement="top-bottom">
